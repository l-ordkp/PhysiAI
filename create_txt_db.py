...
def process_single_pdf(pdf_path, output_dir, llamaparse_api_key, gemini_api_key):
    ...
    image_dir = "C:\\Users\\Kshitij Kumar Pal\\Desktop\\PhysiAI\\img_db"
    ...
    parsed_result = llamaparse_processor.parse(pdf_path)
    
    # Extract images
    print("Extracting images...")
    image_extractor.extract_images(parsed_result, pdf_file)
...
if __name__ == "__main__":
    ...
    # Configuration
    pdf_path = "C:\\Users\\Kshitij Kumar Pal\\Desktop\\PhysiAI\\string.pdf"
    output_dir = "text_db"
